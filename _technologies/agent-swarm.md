...
**Agent Swarm** refers to a multi-agent orchestration pattern where multiple autonomous [AI Agents]({{ site.baseurl }}/technologies/agents/) collaborate, communicate, and hand off tasks to one another to achieve complex goals.
